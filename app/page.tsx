            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked: boolean) => handleCheckboxChange('hasTaxId', checked)}
                />
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value: string) => setFormData(prev => ({ ...prev, fatcaStatus: value }))}
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked: boolean) => handleCheckboxChange('isPep', checked)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked: boolean) => handleCheckboxChange('agreeToTerms', checked)}
                  />
